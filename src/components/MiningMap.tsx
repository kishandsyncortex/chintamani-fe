        ...
        <div className="pt-[33px] pb-[30px] container flex items-start flex-col px-5">
          <div className="py-0 w-full flex flex-row items-stretch justify-center flex-wrap">
            <div className="py-0 relative w-[33.33%] h-[156px] px-5 after:absolute after:top-[118px] after:left-[87px] after:w-[73%] after:h-[100%] after:border-b-[3px] after:border-dotted after:border-[#211c50] after:rotate-[46deg] after:pointer-events-none after:block group">
              ...
              {/* <div className='overflow-visible cursor-pointer'>
              ...
              <div className='opacity-0 flex items-center justify-center w-full bg-[#fff] text-center flex-col flex-wrap absolute top-0 left-0 h-[290px] border-[1px] border-[#000] min-w-[280px] rounded-[10px] z-[99]'>
                <h2 className='text-[15px] text-[#000] font-poppins w-full'>Mining</h2>
                <div className='text-[13px] text-[#000] font-poppins p-[10px] hidden'>
                  A natural diamond is usually so-called because it is <strong>mined from the earth after occurring naturally</strong>. A mined diamond, therefore, is a 'natural' diamond that is formed from carbon being subjected to extreme heat and pressure deep underneath the earth's crust.
                </div>
                <div className='text-[13px] font-light text-[#000] font-poppins p-[10px]'>
                  <p>A natural diamond is usually so-called because it is <strong>mined from the earth after occurring naturally</strong> . A mined diamond, therefore, is a 'natural' diamond that is formed from carbon being subjected to extreme heat and pressure deep underneath the earth's crust.</p>
                </div>
              </div>
            </div> */}
            ...
            <div className="w-[33.34%] h-[156px] items-end text-right py-0 px-5 flex flex-col flex-nowrap">
              <div className="text-[#000] font-poppins font-medium pl-5 pb-[15px]">
                5. Diamonds Awaiting for you
              </div>
              <div className="overflow-visible cursor-pointer inline-flex">
                <div className="overflow-hidden relative flex w-full">
                  ...
                  <div className="hidden opacity-0 flex w-full text-center bg-[#fff] items-center justify-center rounded-[10px] min-w-[280px] border-[1px] border-[#000] h-[290px] z-[99]">
                    <h2 className="text-[15px] text-[#000] font-poppins w-full">
                      Diamonds Awaiting for you
                    </h2>
                    <div className="text-[13px] text-[#000] font-poppins p-[10px]">
          ...
          <div className="py-0 w-full flex flex-row  items-stretch justify-center flex-wrap">
            <div className="w-[33.33%] h-[156px] p-5 flex-col flex items-start flex-nowrap"></div>

            <div className="relative w-[33.33%] h-[156px] px-5 py-0 flex-col flex items-center text-center flex-nowrap after:block after:absolute after:top-[-22px] after:right-[-97px] after:w-[57%] after:h-[100%] after:border-b-[3px] after:border-dotted after:border-[#211c50] after:rotate-[49deg] after:pointer-events-none">
              <div className="overflow-visible cursor-pointer inline-flex">
                <div className="overflow-hidden relative flex w-full">
                  <div className="relative top-0 left-0 w-full flex flex-nowrap flex-col  items-start">
                    <img src={Cutting} alt="Cutting" className="max-w-[100%]" />
                  </div>
                </div>
              </div>
              <div className="text-[15px] text-[#000] font-medium font-poppins w-full">
                3. Cutting & Polishing
              </div>
            </div>
          ...
          <div className="py-0 w-full flex flex-row  items-stretch justify-center flex-wrap">
            <div className="w-[33.33%] h-[156px] pr-[4px] py-0 pl-5 flex-col flex items-end flex-nowrap text-right relative after:absolute after:top-[-77px] after:right-[-224px] after:w-[58%] after:h-[100%] after:border-b-[3px] after:border-dotted after:border-[#211c50] after:rotate-[131deg] after:pointer-events-none">
              <div className="overflow-hidden cursor-pointer inline-flex">
                <div className="overflow-hidden relative w-full flex">
                  <div className="opacity-0 flex items-center justify-center bg-[#fff] text-center w-full invisible rounded-[10px] min-w-[280px]  border-[1px] border-[#000] h-[290px[] z-[99]">
                    <h2 className="text-[15px] text-[#000] font-poppins w-full">
                      Conflict Free Sourcing
                    </h2>
                    <div className="text-[13px] font-poppins text-[#000] p-[10px]">
              ...
              <div className="flex flex-col flex-nowrap items-end relative top-0 left-0 w-full">
                <img src={Conflict} alt="Conflict" className="max-w-[100%]" />
              </div>
              <div className="text-[#000] font-poppins font-medium pb-[15px]">
            ...
            <div className="w-[33.33%] h-[156px] py-0 text-left pl-0 pr-5 flex-col flex items-start flex-nowrap relative after:absolute after:block after:top-[-89px] after:right-[-21px] after:w-[73%] after:h-[100%] after:border-b-[3px] after:border-dotted after:border-[#211c50] after:rotate-[134deg] after:pointer-events-none group">
              <div className="overflow-hidden cursor-pointer inline-flex">
                <div className="overflow-hidden relative flex w-full">
                  ...
                  <div className="opacity-0 min-w-[466px] h-[380px] absolute top-[-358px] left-[-163px] flex items-center justify-center bg-[#fff] text-center w-full invisible rounded-[10px] border-[1px] border-[#000] z-[99] flex-col flex-nowrap">
                    <h2 className="text-[15px] text-[#000] font-poppins w-full">
