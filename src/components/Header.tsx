        ...
        <div className="w-full py-[18px]">
          <div className="container flex mx-auto flex-nowrap justify-start items-stretch">
            ...
            <div className="flex items-center justify-end">
              ...
              >
                {wishListCount ? (
                  <div className="t-0 absolute left-5 bottom-[15px]">
              ...
              >
                {cartCount ? (
                  <div className="t-0 absolute left-6 bottom-[18px]">
                    <p className="flex h-2 w-2 items-center justify-center rounded-full bg-[#211c50] p-2 text-[10px] text-white">
                      {cartCount}
                    </p>
                  </div>
                ...
                {menu && (
                  ...
                  >
                    <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                      <div className="relative grid gap-6 bg-white px-5 py-4 sm:gap-8 sm:py-4">
                        <NavLink
                          to="/account"
